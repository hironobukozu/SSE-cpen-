...
int main() {
  ...
  double pi = estimate_pi(500);
  std::cout << "My estimate of PI is: " << pi << std::endl;

  double pi2 = estimate_pi_multithread_naive(500);
  std::cout << "Estimate of PI is:" << pi2 << std::endl;

  double pi3 = estimate_pi_multithread(1000);
  std::cout << "Estimate of PI is:"<< pi3 << std::endl;
